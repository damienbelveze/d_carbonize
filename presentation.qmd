...
remember the [Lancetgate](https://theconversation.com/lancet-gate-in-the-covid-19-pandemic-era-is-it-alright-for-science-to-be-wrong-140715).
...
::::{.columns}
:::{.column width="50%"}
<img src="images/3_pillars_2.jpg">
:::
:::{.column width="50%"}
...
- **Does the repository's policy restricts the choice of licences that can assigned to your data? : if you cannot share your data under the licence you have chosen, you would better find a better offer elsewhere.**
...
::::{.columns}
:::{.column width="50%"}
<img src="images/data_available_request.jpg">
:::
:::{.column width="50%"}
:::{.incremental}

- A DAS cannot contain: Data not available

- if Available Upon Request (AUR): somebody has to answer the request

-  n=3416 : no answer or negative answer without any justification
:::
:::{.notes}
